...
python -m torch.distributed.run --nproc_per_node=$NGPU train_flow.py \
        ...
        --batch_size 6 --max_epochs 100 --sample 100 \
        --num_sampling_steps 2 --samples_per_contrast 4000 --balance_by anatomy_artifact \
        --cfg_dropout_prob 0.1 --size 192 --checkpoint_path /vast/tibrahim/jil202/autoflow/checkpoints_uncertainty/flow_matching_3d_brain_knee_prostate_best_epoch_19.pt
